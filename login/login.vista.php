                ...
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body p-5">
                            ...
                            <form method="POST" action="login.controlador.php" class="needs-validation" novalidate="" autocomplete="off">
                                <div class="mb-3">
                        ...
                        <div class="card-footer py-3 border-0">
                            <div class="text-center">
                                <a href="registro.vista.php" class="text-dark">Crear nueva cuenta</a>
                            </div>
                        </div>
                    </div>
